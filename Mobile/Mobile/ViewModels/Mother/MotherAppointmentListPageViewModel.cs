...
namespace Mobile.ViewModels {
    public class MotherAppointmentListPageViewModel : ViewModelBase {
        ...
        #region Constructor
        public MotherAppointmentListPageViewModel(INavigationService navigationService,
                                                IEventAggregator eventAggregator,
                                                IUserDialogs dialogs,
                                                ICommonFunction commonFunction,
                                                IMotherDataService motherDataService)
            : base(navigationService, eventAggregator, dialogs, commonFunction, Message.CAP_MOTHER_APPOINTMENTS) {
        ...
        private async Task LoadData() {
            List<Mother> items = await _motherDataService.GetTodayItemsAsync();
        ...
        private async Task CallbackCreationAccepted() {
            ...
            await NavigationService.NavigateAsync(AppConstant.Screen.MOM_APPOINTMENT_PAGE, navigationParameters);
        }
        ...
        private async Task OnItemSelected(Mother mother) {
            try {
                _selectedItem = mother;
