...
namespace Mobile.ViewModels {
    public class BabyListPageViewModel : ViewModelBase {
        ...
        #region Constructor
        public BabyListPageViewModel(INavigationService navigationService,
        ...
        private async Task LoadData() {
            List<Baby> items = await _babyDataService.GetItemsAsync();
        ...
        private async Task CallbackCreationAccepted() {
            ...
            await NavigationService.NavigateAsync(AppConstant.Screen.BABY_PAGE, modifyNavigationParameters);
        }
        #endregion
        ...
        private async Task OnItemSelected(Baby selectedItem) {
            try {
        ...
        private async Task InvokeCreateNew() {
            await DisplayMessage(MessageType.Question, Message.CAP_CREATE_BABY, Message.MSG_COM_003, null, true, AppConstant.NavigationParameterName.CALL_BACK_CREATE_ACCEPTED);
        }
        ...
        private async Task OpenItemDetailsPage() {
            ...
            await NavigationService.NavigateAsync(AppConstant.Screen.BABY_PAGE, navigationParameters);
        }
        #endregion
