...
namespace Mobile.Views {
    public partial class BabyAppointmentListPage : ScanPage {
        ...
        #region Constructor
        public BabyAppointmentListPage() {
            try {
                InitializeComponent();
        ...
        private void OnBindingContextChanged(object sender, System.EventArgs e) {
            if (BindingContext != null) {
                ...
                ((BabyAppointmentListPageViewModel)BindingContext).SetCustomMapCommand.Execute(s);
            }
        }
        ...
        private void OnTabValueChanged(object sender, Tab.ValueChangedEventArgs e) {
            if (BindingContext != null) {
                ...
                ((BabyAppointmentListPageViewModel)BindingContext).SetTabClickedCommand.Execute(e);
            }
        }
        #endregion
