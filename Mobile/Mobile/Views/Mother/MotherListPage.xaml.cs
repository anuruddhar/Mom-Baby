...
namespace Mobile.Views {
    public partial class MotherListPage : ScanPage {
        ...
        private void OnBindingContextChanged(object sender, System.EventArgs e) {
            if (BindingContext != null) {
                ...
                ((MotherListPageViewModel)BindingContext).SetCustomMapCommand.Execute(s);
            }
        }
        ...
        private void OnTabValueChanged(object sender, Tab.ValueChangedEventArgs e) {
            if (BindingContext != null) {
                ...
                ((MotherListPageViewModel)BindingContext).SetTabClickedCommand.Execute(e);
            }
        }
        #endregion
