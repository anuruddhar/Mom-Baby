...
namespace Mobile.Views {
    public partial class MotherAppointmentListPage : ScanPage {
        ...
        #region Constructor
        public MotherAppointmentListPage() {
            try {
                InitializeComponent();
        ...
        private void OnBindingContextChanged(object sender, System.EventArgs e) {
            if (BindingContext != null) {
                ...
                ((MotherAppointmentListPageViewModel)BindingContext).SetCustomMapCommand.Execute(s);
            }
        }
        ...
        private void OnTabValueChanged(object sender, Tab.ValueChangedEventArgs e) {
            if (BindingContext != null) {
                ...
                ((MotherAppointmentListPageViewModel)BindingContext).SetTabClickedCommand.Execute(e);
            }
        }
        #endregion
