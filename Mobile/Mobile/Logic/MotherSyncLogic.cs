...
namespace Mobile.Logic {
    ...
    public class MotherSyncLogic : ISyncLogic {

        #region Private Variables
        private static readonly Lazy<MotherSyncLogic> LazySingleton =
                 new Lazy<MotherSyncLogic>(CreateSingleton);
        ...
        #region Properties
        public static MotherSyncLogic Instance => LazySingleton.Value;

        public string AnimationFileName { get; set; } = AppConstant.AnimationFile.UPLOADING;
        public string ClientMessage { get; set; } = Message.MSG_INI_002;
        ...
        #region Constructor
        private MotherSyncLogic() {
        }

        private static MotherSyncLogic CreateSingleton() {
            return new MotherSyncLogic();
        }
        #endregion
