...
namespace Mobile.Logic {
    ...
    public class BabySyncLogic : ISyncLogic {

        #region Private Variables
        private static readonly Lazy<BabySyncLogic> LazySingleton =
                 new Lazy<BabySyncLogic>(CreateSingleton);
        ...
        #region Properties
        public static BabySyncLogic Instance => LazySingleton.Value;

        public string AnimationFileName { get; set; } = AppConstant.AnimationFile.UPLOADING;
        public string ClientMessage { get; set; } = Message.MSG_INI_001;
        ...
        #region Constructor
        private BabySyncLogic() {
        }

        private static BabySyncLogic CreateSingleton() {
            return new BabySyncLogic();
        }
        #endregion
