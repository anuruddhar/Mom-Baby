...
namespace Mobile.Services.BabyAppoinmentService {
    ...
    public class BabyAppoinmentService : BaseService, IBabyAppoinmentService {

        public BabyAppoinmentService(IRequestProvider requestProvider) : base(requestProvider, "BabyAppoinmentService") { }
